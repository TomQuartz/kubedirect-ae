...
export WORKLOAD=${WORKLOAD:-"test-deployment"}
...
echo "Running deployment breakdown experiment: baseline=$baseline, selector=$WORKLOAD, #deployments=$n_deployments, #pods=$n_pods"
